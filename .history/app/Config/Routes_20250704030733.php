...
$routes->group('diskon', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->post('', 'DiskonController::create'); // ✅ tambahkan ini untuk menangani POST ke /diskon
    $routes->post('apply', 'DiskonController::apply');
    $routes->post('update/(:num)', 'DiskonController::update/$1');
    $routes->get('delete/(:num)', 'DiskonController::delete/$1');
});

$routes->get('transaksi/detail/(:num)', 'TransaksiController::detailTransaksi/$1');
