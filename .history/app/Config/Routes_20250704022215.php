...
$routes->group('keranjang', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->post('', 'TransaksiController::cart_add'); // tetap bisa, opsional
    $routes->post('add', 'TransaksiController::cart_add'); // ✅ inilah yang dibutuhkan
...
$routes->group('diskon', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->post('apply', 'DiskonController::apply');       // kalau ada logic diskon
    $routes->post('create', 'DiskonController::create');     // ✅ tambah diskon
    $routes->post('update/(:num)', 'DiskonController::update/$1'); // ✅ update diskon
    $routes->get('delete/(:num)', 'DiskonController::delete/$1');  // ✅ hapus diskon
});
