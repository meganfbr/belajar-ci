            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2"></td>
                        <td>Total</td>
                        <td><span id="total"><?= number_to_currency($total_setelah_diskon, 'IDR') ?></span></td>
                    </tr>
                </tbody>
            </table>
...
$(document).ready(function() {
    var ongkir = 0;
    var total = <?= $total_setelah_diskon ?>;
    hitungTotal();
...
$("#kelurahan").on('change', function() {
    ...
    total = ongkir + <?= $total_setelah_diskon ?>;
    $("#ongkir").val(ongkir);
    $("#total").html("IDR " + total.toLocaleString('id-ID'));
    $("#total_harga").val(total); // disimpan ke form
    }
